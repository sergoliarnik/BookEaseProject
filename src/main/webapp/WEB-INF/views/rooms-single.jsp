    ...
    <div class="container">
        <div class="row no-gutters slider-text d-flex align-itemd-end justify-content-center">
            <div class="col-md-9 ftco-animate text-center d-flex align-items-end justify-content-center">
                <div class="text">
                    <p class="breadcrumbs mb-2" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"><span class="mr-2"><a href="index.html"><spring:message code="navigation.home"/></a></span> <span class="mr-2"><a href="rooms.html"><spring:message code="rooms"/></a></span> <span><spring:message code="rooms.room"/></span></p>
                            ...
                            <div class="col-sm col-md-6 ftco-animate">
                                <div class="room">
                                    ...
                                    <div class="text p-3 text-center">
                                        ...
                                        <hr>
                                        <p class="pt-1"><a href="room-single.html" class="btn-custom"><spring:message code="rooms.view_room_details"/> <span class="icon-long-arrow-right"></span></a></p>
                                    </div>
                                </div>
                            </div>
                        </div>
