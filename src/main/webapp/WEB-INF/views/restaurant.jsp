...
<!DOCTYPE html>
<html lang="en">
<spring:message code="restaurant.restaurant" var="restaurant_i18n"/>
<jsp:include page="includes/head.jsp">
    <jsp:param name="title" value="${restaurant_i18n}"/>
</jsp:include>
<body>
    ...
    <div class="container">
        <div class="row no-gutters slider-text d-flex align-itemd-end justify-content-center">
            <div class="col-md-9 ftco-animate text-center d-flex align-items-end justify-content-center">
                <div class="text">
                    <p class="breadcrumbs mb-2"><span class="mr-2"><a href="/">Home</a></span> <span>Restaurants</span></p>
