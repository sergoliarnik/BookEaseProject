...
<!DOCTYPE html>
<html lang="en">
<spring:message code="hotels.hotel" var="hotel_i18n"/>
<jsp:include page="includes/head.jsp">
    <jsp:param name="title" value="${hotel_i18n}"/>
</jsp:include>
<body>
    ...
    <div class="container">
        <div class="row no-gutters slider-text d-flex align-itemd-end justify-content-center">
            <div class="col-md-9 ftco-animate text-center d-flex align-items-end justify-content-center">
                <div class="text">
                    <p class="breadcrumbs mb-2" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"><span class="mr-2"><a href="index.html">Home</a></span> <span>Hotel</span></p>
                    <h1 class="mb-4 bread">${hotelWithRoomsDto.name}</h1>
                </div>
            </div>
        </div>
    </div>
                            ...
                            <div class="col-sm col-md-6 ftco-animate">
                                <div class="room">
                                    ...
                                    <div class="text p-3 text-center">
                                        ...
                                        <hr>
                                        <p class="pt-1"><a href="/rooms/${room.id}" class="btn-custom">View Room Details <span class="icon-long-arrow-right"></span></a></p>
                                    </div>
                                </div>
                            </div>
                            </c:forEach>
